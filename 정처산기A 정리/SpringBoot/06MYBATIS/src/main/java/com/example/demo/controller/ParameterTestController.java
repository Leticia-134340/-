...
public class ParameterTestController {
	...
	// @RequestBody : 비동기요청 파라미터 처리 / form / json 등 파라미터 받기 /범위가 더 넓다
	...
	public void p09( PersonDto dto)	//@ModelAttribute 생략 가능
	{
		log.info("GET /param/p09..."+ dto);
	}

	/*
	 * @GetMapping("/page01") public void page01(PersonDto dto) {
	 ...
	 */
		...
		//뷰이동 + 데이터전달(Model객체 - DispatherServlet(FC))
...
//			model.addAttribute("r1","r1Value");
			redirectAttributes.addAttribute("r1","r1Value"); //쿼리스트링 //2번에서 1번 값을 받도록 명령
