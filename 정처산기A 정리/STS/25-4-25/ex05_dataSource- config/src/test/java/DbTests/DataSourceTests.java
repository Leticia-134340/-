...
class DataSourceTests {
	...
	void test1() throws Exception{
		...
		PreparedStatement pstmt = conn.prepareStatement("insert into tbl_book values('2233', 'abcd','abcd','abcd')");
		pstmt.executeUpdate();
	...
	void test3() throws Exception{
		...
		PreparedStatement pstmt = conn.prepareStatement("insert into tbl_book values('2234', 'abcd','abcd','abcd')");
		pstmt.executeUpdate();
	...
	void test4() throws Exception{
		...
		PreparedStatement pstmt = conn.prepareStatement("insert into tbl_book values('2235', 'abcd','abcd','abcd')");
		pstmt.executeUpdate();
