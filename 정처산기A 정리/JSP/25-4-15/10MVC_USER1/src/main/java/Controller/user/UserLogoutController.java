...
public class UserLogoutController implements SubController {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		//속성 정보 유효성 체크
			...
			String username = (String)session.getAttribute("username");	//세션에서 값 받아오기
			
			if(isAuth==null || isAuth==false) {
				req.setAttribute("message", "로그인 된 상태가 아닙니다");
			...
			Boolean isLogout = (Boolean)serviceResponse.get("logout");
