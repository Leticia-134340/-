<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
		...
		if(password.isEmpty()){
			//out.println("<script>alert('password을 입력하세요');location.href='./logins_form.jsp'</script>");
		...
		out.println("<script> alert('로그인 성공! MAIN page로 이동합니다.');location.herf='main.jsp'</script>");
