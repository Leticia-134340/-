...
//			  connectionPool.add(new ConnectionItem(conn,i));
            ...
            //XAConnection xaConnection = dataSource.getXAConnection(); //분산 트랜잭션을 처리할 수 있는 JDBC 연결 객체
	...
	public static ConnectionPool getInstance() throws SQLException, Exception {
		if(instance==null)
