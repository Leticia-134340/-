...
class Board implements Serializable{		//오브젝트 전달할 때 무조건 상속관계로 둬야 오류가 생기지 않음
											//직렬화
	private static final long serialVersionUID = 1L;	//버전 정보	//역직렬화
