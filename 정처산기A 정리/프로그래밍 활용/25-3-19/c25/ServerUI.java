...
class Sgui extends JFrame implements ActionListener,KeyListener
{
	...
	Sgui() throws Exception{
		...
		server = new ServerSocket(7001); 	//192.168.16.70
		...
		area.append("[CLIENT] "+client.getInetAddress()+ "접속하겠습니다\n");
		
		//수신 스레드 생성
		ServerRecvThread recv = new ServerRecvThread(din,this);	//Sgui 주소 전달
