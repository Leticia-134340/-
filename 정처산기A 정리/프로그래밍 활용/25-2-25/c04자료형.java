...
//		System.out.printf("%d %d %d %d\n", n1,n2,n3,n4);
		...
		//-------------------------------
//		byte n5 = (byte)-129;					// 크기가 너무 커서 자료형 변환을 할 수 없음 아
...
//		System.out.printf("%d\n", n9);	//왜 ??
//		System.out.println(0b10101101);	//왜 음수가 x??
...
//		byte c = a + b;
		...
		//------------------------------
		//정수 short-2byte 정수 부호 o | char - 2byte정수 부홑(양수만)
		//------------------------------
...
//
//		long n3 = 10000000000L; //문제발생 왜>? 자료형
...
//		//오차확인
//		float num = 0.1F; //보통 소수점 6에서 9자리까지 유효
//		for(int i=0;i<=1E5;i++) {
//			num=num+0.1F;
